...
using 鹰眼OCR_WPF.Messages.TextBox;
using 鹰眼OCR_WPF.Messages.TextBox.MessageParam;
...
namespace 鹰眼OCR_WPF.Views
{
    ...
    public partial class HomeView : UserControl
    {
        ...
        {
            // 发送消息，给SearchWindow
            WeakReferenceMessenger.Default.Send(new DictionaryMessage(new Dictionary<string, object>() { { MessageTokens.HomeView, info } }), MessageTokens.SearchWindow);
        }
